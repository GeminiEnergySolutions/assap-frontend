...
export class AuditZoneService {
  ...
  getSingleZone(auditId: number, zoneId: number): Observable<Response<Zone>> {
    return this.http.get<Response<Zone>>(`${environment.api}/audit/${auditId}/zone/${zoneId}`);
  }

  getAllAuditZone(auditId: number): Observable<Response<Zone[]>> {
    return this.http.get<Response<Zone[]>>(`${environment.api}/audit/${auditId}/zone`);
  }

  createAuditZone(dto: CreateZoneDto): Observable<Response<Zone>> {
    return this.http.post<Response<Zone>>(`${environment.api}/audit/${dto.auditId}/zone`, dto);
  }

  updateAuditZone(auditId: number, zoneId: number, data: UpdateZoneDto): Observable<Response<Zone>> {
    return this.http.put<Response<Zone>>(`${environment.api}/audit/${auditId}/zone/${zoneId}`, data);
  }

  duplicateAuditZone(auditId: number, zoneId: number, count: number): Observable<Response<Zone[]>> {
    return this.http.post<Response<Zone[]>>(`${environment.api}/audit/${auditId}/zone/${zoneId}/duplicate`, {
  ...
  getZoneData(zoneId: number): Observable<Response<ZoneData>> {
    return this.http.get<Response<ZoneData>>(`${environment.api}/formData/zone/${zoneId}`);
  }

  createZoneData(zoneId: number, formData: CreateZoneData): Observable<Response<ZoneData>> {
    return this.http.post<Response<ZoneData>>(`${environment.api}/formData/zone/${zoneId}`, formData);
  }

  updateZoneData(zoneId: number, formData: ZoneData): Observable<Response<ZoneData>> {
    return this.http.put<Response<ZoneData>>(`${environment.api}/formData/zone/${zoneId}`, formData);
  }
}
